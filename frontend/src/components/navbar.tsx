...
const Navbar = () => {
    ...
    return (
        <>
            <div className="fixed top-0 left-0 right-0 z-50 bg-[#373b69] px-5 py-2 flex flex-row justify-between items-center sm:px-8">
            ...
            <AnimatePresence>
                {menuOpen && (
                    <motion.div
                        ...
                        className="fixed top-[52px] left-0 right-0 z-40 bg-slate-300 flex flex-col pl-8 py-4">
